...
Import the public module and mount the generated surface into the Gin router
...
If your host already has a router, register the surface on that router. The
...
Contracts come from
`github.com/candacelabs/candace/proto/candace/brainspine/v1`; the generated HTTP
