...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -source=surface.go -destination=internal/mocks/http.gen.go -package=csfmocks
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -source=api_cgen.go -destination=internal/mocks/api.gen.go -package=csfmocks
