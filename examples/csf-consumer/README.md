...
go mod edit -require=github.com/candacelabs/candace@v0.0.0
go mod edit -replace=github.com/candacelabs/candace=../candace-<sha12>
go mod tidy
go mod vendor
...
use `go get github.com/candacelabs/candace@export-<sha12>` and omit that replace.
