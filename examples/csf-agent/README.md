...
adapter directly. Mounting `csf.NewSurface(service)` also exposes
`PrepareAgentAssignment` through the existing HTTP and MCP surfaces; no
additional listener is required.
