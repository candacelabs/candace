...
// harnessT is the minimal subset of *testing.T that the deterministic election
...
// permissive MockTransport where every peer is unreachable and any number of
...
func stubTransport() warden.Transport {
